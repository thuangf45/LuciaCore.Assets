export function render(node) {
    ...
    return {
        html: `
            <div id="${nodeId}" class="lucia-loader-container" style="${node.style || ''}">
                <div class="truckWrapper" data-action="${node.action || ''}">
                    <div class="truckBody">
        ...
        css: `
            ...
            #${nodeId} .truckBody {
                ...
                height: fit-content;
                margin-bottom: 6px;
                animation: motion_${nodeId} 1s linear infinite;
            }
            ...
            #${nodeId} .road::before {
                ...
                right: -50%;
                border-radius: 3px;
                animation: roadAnimation_${nodeId} 1.4s linear infinite;
            ...
            /* Hiệu ứng nhún (Suspension) độc lập */
            @keyframes motion_${nodeId} {
                0% { transform: translateY(0px); }
                50% { transform: translateY(3px); }
                100% { transform: translateY(0px); }
            }

            /* Hiệu ứng di chuyển đường & cột đèn độc lập */
            @keyframes roadAnimation_${nodeId} {
